...
class SearchPostListRepositoryImpl @Inject constructor(
    ...
    override suspend fun getPostList(searchKey: String): Flow<List<VideoPost>> {
        return apiService.searchVideo(searchKey).map { searchVideoResponse ->
            // Convert SearchVideoResponse to List<VideoPost>
            searchVideoResponse.hits.map { videoData ->
                VideoPost(
                    id = videoData.id,
                    ...
                    type = videoData.type,
                    isBookmark = false,
                    videos = hashMapOf("large" to Video("large", videoData.videos.large.url,
                        ...
                        "medium" to Video("medium", videoData.videos.medium.url,
                        ...
                        "tiny" to Video("tiny", videoData.videos.tiny.url,
                        ...
                        "small" to Video("small", videoData.videos.small.url,
